    ...
    <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition transform hover:-translate-y-1 duration-300">
      <div className="relative">
        ...
        <div className="absolute top-0 right-0 m-3">
          <span className={`py-1 px-3 rounded-full text-xs font-medium uppercase ${
            ...
            event.category === 'business' ? 'bg-amber-100 text-amber-800' :
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          <div className="flex justify-end">
            <div className={`py-1 px-3 inline-block rounded-full text-sm font-medium ${event.registrationOpen ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
...
const Events = () => {
      ...
      setEvents([
        {
          ...
          category: "technology",
          description: "Join us for our annual technology showcase featuring student projects, industry speakers, and hands-on workshops. This year's theme is 'Innovation for Sustainability' with special emphasis on green technologies.",
        ...
        },
        {
          ...
          registrationOpen: true,
          category: "cultural",
          description: "Experience a vibrant evening filled with music, dance, and theatrical performances by talented students. Traditional and contemporary performances showcasing the rich cultural diversity of our institution.",
          image: "/api/placeholder/600/400",
          highlights: [
        ...
        },
        {
          ...
          registrationOpen: true,
          category: "sports",
          description: "Annual inter-college sports competition featuring various sports including cricket, football, basketball, volleyball, and athletics. Open for all college students with exciting prizes for winners.",
          image: "/api/placeholder/600/400",
          highlights: [
        ...
        },
        {
          ...
          category: "business",
          description: "Connect with successful entrepreneurs, investors, and business leaders. Learn about the latest trends in startups and get insights on building sustainable businesses in today's competitive environment.",
          image: "/api/placeholder/600/400",
          highlights: [
        ...
        },
        {
          ...
          registrationOpen: true,
          category: "academic",
          description: "Annual science exhibition showcasing innovative projects by students from various departments. Special focus on renewable energy, biotechnology, and environmental science this year.",
          image: "/api/placeholder/600/400",
          highlights: [
  ...
  const handleRegister = (eventId) => {
    ...
    alert(`Registration submitted for event #${eventId}. Check your email for confirmation.`);
  };
