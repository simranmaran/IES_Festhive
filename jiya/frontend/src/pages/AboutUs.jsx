  ...
  const teamMembers = [
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMy2WByAqJuHbPO6eVXpOE7bu2FkxuZu0oeHhO5VPKJGlFu5HQkn6sZGDtBTw9en7tb5M&usqp=CAU",
  ...
  const faqs = [
    {
      ...
      answer: "You can register for events through our website by creating an account and signing up for specific events. Registration typically opens 2 months before the festival."
    },
    {
      question: "Are there any participation fees?",
      answer: "Most events have nominal participation fees that vary based on the event type. Some events are free for students from affiliated colleges. Check individual event pages for details."
    },
    {
      question: "Can I volunteer for IES Festhive?",
      answer: "Yes! We welcome volunteers. Visit our 'Join Us' section and fill out the volunteer application form. We have roles in event management, marketing, technical support, and more."
    },
    {
      question: "Do you provide accommodation for outstation participants?",
      answer: "Yes, we provide accommodation at subsidized rates for outstation participants. This needs to be requested during registration and is subject to availability."
    }
  ];
          ...
          >
            {activeTab === "mission" && (
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  At IES Festhive, our mission is to create a vibrant platform where students can showcase their talents, foster innovation, and build lasting connections. We strive to provide an inclusive space that celebrates diversity and encourages cultural exchange among educational institutions across the nation.
                </p>
                <p className="text-lg text-gray-600">
                  Through our diverse range of events spanning technology, arts, culture, and sports, we aim to nurture holistic development and provide experiences that go beyond the classroom, preparing students for the challenges of tomorrow.
                </p>
              </div>
            )}
            ...
            {activeTab === "vision" && (
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  We envision IES Festhive as the premier collegiate festival in India, recognized for its excellence in event curation, participant experience, and social impact. We aspire to be a catalyst for discovering emerging talent and providing a springboard for students to realize their potential.
                </p>
                <p className="text-lg text-gray-600">
                  By 2030, we aim to expand our reach to international participants, fostering global cultural exchange and collaboration while maintaining our core values of inclusivity, innovation, and integrity.
                </p>
              </div>
            )}
            ...
            {activeTab === "history" && (
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  IES Festhive began in 2010 as a small departmental celebration with just 5 events and 200 participants. Founded by a group of passionate students who wanted to create opportunities for inter-college interaction, the festival quickly gained popularity for its unique events and welcoming atmosphere.
                </p>
                <p className="text-lg text-gray-600">
                  Over the years, we've grown exponentially, hosting national-level competitions, bringing in celebrity judges, and partnering with industry leaders. From our humble beginnings to becoming one of India's largest collegiate festivals, our journey reflects our commitment to excellence and continuous innovation.
                </p>
              </div>
            )}
          </div>
      ...
      <div ref={statsRef} className="bg-gradient-to-br from-purple-800 to-purple-900 py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className={`${fadeInUpClassName(100)} bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center`}>
            ...
            <div className={`${fadeInUpClassName(200)} bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center`}>
            ...
            <div className={`${fadeInUpClassName(300)} bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center`}>
            ...
            <div className={`${fadeInUpClassName(400)} bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center`}>
      ...
      <div className="bg-gray-100 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need to know about IES Festhive
            </p>
          </div>
