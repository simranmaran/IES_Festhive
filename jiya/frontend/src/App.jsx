...
import Events from "./pages/Events"; // Corrected import for Events component
...
const Header = () => {
  ...
  return shouldShowHeader ? <Navbar /> : null;
};
    ...
    <BrowserRouter>
      <CartProvider>
        ...
        <Routes>
          ...
          <Route path="/Events" element={<Events />} /> {/* Use Events component directly */}
